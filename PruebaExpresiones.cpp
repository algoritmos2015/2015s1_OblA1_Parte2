...
void PruebaExpresiones::PruebaSimple1()
{
	...
	ExpresionImp *a2 = new ExpresionImp(10);
	ExpresionImp e(*a2);
	
	TipoRetorno retorno = ERROR;
	bool error = false;
	cout<< a <<endl;
	...
	retorno = ERROR;
	cout<< e <<endl;
	if(e.Evaluar(error) == 10 &&error==false) retorno = OK;
	ver(retorno, OK, "Expresion e = 10 (copia de a)");
};
...
{	
	...
	//cout<<"Resultado Esperado: "<< "(5+5+5)/5	"<<endl; c.Formula();
	if(c.Evaluar(error) == 3 && error==false) retorno = OK;
	ver(retorno, OK, "Expresion c = 3");
...
{	
	...
	if(c.Evaluar(error) == 143 && error==false) retorno = OK;
	ver(retorno, OK, "Expresion c = 143");

	retorno = ERROR;
	c = c * a;
	cout<<"Expresion c = c * a [(a * (a + b) ) * a]: "<< c <<endl;
	if(c.Evaluar(error) == 1573 && error==false) retorno = OK;
	ver(retorno, OK, "Expresion c = 1573");

	retorno = ERROR;
	c = (a - b) * (a + b);
	cout<<"Expresion c = (a - b) * (a + b): "<< c <<endl;
	if(c.Evaluar(error) == 117 && error==false) retorno = OK;
	ver(retorno, OK, "Expresion c = 117");


	retorno = ERROR;
	b = (*d);
	c = (a - b) * (a + b);
	cout<<"Expresion b = d: "<<b <<endl;
	cout<<"Expresion c = (a - b) * (a + b): "<< c <<endl;
	if(c.Evaluar(error) == 105 && error==false) retorno = OK;
	ver(retorno, OK, "Expresion c = 105");
	

	retorno = ERROR;
	d = c.Clon();
	cout<<"Expresion d = c.clon: "<< *d <<endl;
	if(d->Evaluar(error) == 105 && error==false) retorno = OK;
	ver(retorno, OK, "Expresion d = 105");
};
